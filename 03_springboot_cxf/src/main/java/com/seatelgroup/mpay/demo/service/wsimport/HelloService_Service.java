 ...
 * 
 */
@WebServiceClient(name = "helloService", targetNamespace = "http://service.seatel.com/", wsdlLocation = "http://localhost:8081/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://service.seatel.com/", "helloService");
     ...
     */
    @WebEndpoint(name = "helloService")
    public HelloService getHelloService() {
        return super.getPort(new QName("http://service.seatel.com/", "helloService"), HelloService.class);
    }
     ...
     */
    @WebEndpoint(name = "helloService")
    public HelloService getHelloService(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.seatel.com/", "helloService"), HelloService.class, features);
    }
